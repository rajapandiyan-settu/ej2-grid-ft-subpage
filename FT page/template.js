...
window.data = {
  ...
  "ChooseRightApproach": {
    "Eyebrow": "Find the Right Template for Your Requirements",
    "MainTitle": "Choose the Right Template for Your Workflow",
  ...
  "Resources": {
    ...
    "MainTitle": "Explore Templates Demos and Documentation",
    "Subtitle": "Explore documentation, demos, guides, and sample implementations to build grid templates efficiently.",
    "Options": [
      {
  ...
  "FAQ": {
    "Eyebrow": "FAQ",
    "MainTitle": "Data Grid Templates Questions",
    "Subtitle": "Frequently Asked Questions About Template Customization and Implementation",
    "Options": [
      {
  ...
  "RelatedArticles": {
    ...
    "MainTitle": "Continue Exploring Data Grid Features",
