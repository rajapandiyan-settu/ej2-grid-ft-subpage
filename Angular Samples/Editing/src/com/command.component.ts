...
@Component({
  selector: 'app-command-column-editing',
  standalone: true,
  imports: [CommonModule, GridModule],
  providers: [EditService, FilterService, ToolbarService, SortService, CommandColumnService],
  template: `
    <ejs-grid
      #grid
      [dataSource]="data"
...
export class CommandColumnEditingComponent implements OnInit {
