...
const CellEditing = ({gridRef}) => {
  ...
  return (
    <GridComponent ref={gridRef} dataSource={data} editSettings={editOptions} toolbar={toolbarOptions} allowSorting={true} allowFiltering={true} filterSettings={filterOptions} height={315} rowHeight={44}>
      <ColumnsDirective>
